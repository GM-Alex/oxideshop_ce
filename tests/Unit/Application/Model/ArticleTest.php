...
use \OxidEsales\EshopCommunity\Application\Model\SimpleVariant;
...
class ArticleTest extends \OxidTestCase
{
    ...
    public function testGetReviews()
    {
        ...
        $this->assertTrue($aReviews instanceof StandardList);
    ...
    public function testGetVariantsInList()
    {
        ...
        foreach ($oVariants as $oVariant) {
            $this->assertTrue($oVariant instanceof SimpleVariant);
        }
    }
    ...
    public function testGetVariants_NOT_InList()
    {
        ...
        $this->assertTrue(count($oVariants) > 0);
        foreach ($oVariants as $oVariant) {
            $this->assertTrue($oVariant instanceof Article);
        }
    }
    ...
    public function testRemoveInactiveVariantsNoStock()
    {
        ...
        $this->assertTrue($oVL instanceof StandardList);
