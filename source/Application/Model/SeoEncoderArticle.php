...
class SeoEncoderArticle extends \oxSeoEncoder
{
    ...
    protected function _getRecomm($oArticle, $iLang)
    {
        ...
        if ($oView instanceof \OxidEsales\EshopCommunity\Core\View) {
    ...
    protected function _getCategory($oArticle, $iLang)
    {
        $oCat = null;
        $oView = $this->getConfig()->getActiveView();
        if ($oView instanceof \OxidEsales\EshopCommunity\Application\Controller\BaseController) {
            $oCat = $oView->getActiveCategory();
        } elseif ($oView instanceof \OxidEsales\EshopCommunity\Application\Controller\BaseController) {
    ...
    protected function _getVendor($oArticle, $iLang)
    {
        ...
        if ($sActVendorId = $oArticle->oxarticles__oxvendorid->value) {
            if ($oView instanceof \OxidEsales\EshopCommunity\Application\Controller\BaseController && ($oActVendor = $oView->getActVendor())) {
                $oVendor = $oActVendor;
            } else {
    ...
    protected function _getManufacturer($oArticle, $iLang)
    {
        ...
        if ($sActManufacturerId = $oArticle->oxarticles__oxmanufacturerid->value) {
            ...
            if ($oView instanceof \OxidEsales\EshopCommunity\Application\Controller\BaseController && ($oActManufacturer = $oView->getActManufacturer())) {
